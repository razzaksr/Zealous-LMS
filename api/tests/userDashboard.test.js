...
describe('GET /getCodingTestsToUsers/:id', () => {
  it('should return 404 if no coding tests are assigned to the user', async () => {
    ...
    const res = await request(app).get(`/userDashboardApi/getCodingTestsToUsers/${mockUserId}`);
  ...
  it('should return coding tests if user has codingTestsAssigned', async () => {
    const mockUserId = '6703bccac801c34498e5649a';
    const mockCodingTestsAssigned = ['6703bccac801c34498e5649b', '6703bccac801c34498e5649c'];
    const mockCodingTests = [
      { _id: '6703bccac801c34498e5649b', title: 'Test 1', description: 'Coding test 1' },
      { _id: '6703bccac801c34498e5649c', title: 'Test 2', description: 'Coding test 2' },
    ];
...
describe('GET /getProblemsByCodingTestsId/:id', () => {
  it('should return 404 if no problems are found for the coding test', async () => {
    ...
    const res = await request(app).get(`/userDashboardApi/getProblemsByCodingTestsId/${mockCodingTestId}`);
  ...
  it('should return problems if coding test has associated problems', async () => {
    const mockCodingTestId = '6703bccac801c34498e5649a';
    const mockProblemIds = ['6703bccac801c34498e5649b', '6703bccac801c34498e5649c'];
    const mockProblems = [
      { _id: '6703bccac801c34498e5649b', title: 'Problem 1', description: 'First problem' },
      { _id: '6703bccac801c34498e5649c', title: 'Problem 2', description: 'Second problem' }
    ];
...
describe('GET /getTestcasesByProblemId/:id', () => {
    ...
    it('should return test cases if problem has associated test cases', async () => {
      const mockProblemId = '6703bccac801c34498e5649a';
      const mockTestcaseIds = ['6703bccac801c34498e5649b', '6703bccac801c34498e5649c'];
      const mockTestcases = [
